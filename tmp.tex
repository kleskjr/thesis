...
\everymath{\textstyle}
  ...
  \mainmatter
    \include{intro}
    \include{modulationofswrs2}
    %\include{ch_transient_oscillations}
    %\include{ch_probing_ca1}
    %\include{ch_gabaergic_modulation}
    %\include{ch_olm_recruitment}
    %\include{ch_outlook}
    %\include{appendixA}
  \backmatter
    %\nocite{*}                
    ...
    \bibliography{refs_intro,refs_swrs}%lit
    %\listoffigures
    %\listoftables    
    %\printindex
