...
\section{Introduction}
  ...
  \label{swr_modulation}
    ...
    %decreases the SW incidence \textit{in vivo} \citep{Suzuki1988}, however up
...
%________________
  ...
  \subsection{Gabazine effects on sharp-wave ripples {\textit {in vitro}} }
    ...
    The found effect of gabazine on the SW amplitude is at odds with the
  ...
  \subsection{Gabazine effects on sharp-wave incidence {\textit {in silico} }}
    ...
    Not surprisingly, {\it in-silico} gabazine drastically increased the rate
...
\section{Discussion}
  ...
  \label{sec:disc_gabazine}
    ...
    \subsubsection{Hypothesis on how gabazine affects sharp-wave incidence} 
      ...
      The increased firing of the perisomatic-targeting interneurons discussed
...
%________________
  ...
  \subsection{Data and data analysis}
    ...
    Sharp waves (SWs) were detected as positive deflections of the in the
...
\begin{comment}
\section{todo}
  - add refs to kohus evoking SWRs by activating PVBC
  
  - gabaar figure 3 horizontal subplots; change legend

  - redo 3pop fig with ee conn

  - both2008 ripples

  - rm it et al commands are deprecated
  ...
  - take the 30\% most hyperpolyrised cells and see if they are asoociated to bigger SW or longer iSWi
    ...
    feedback for R:
      - bicuculine decreases SW incidence 
      - in mamalia (buzsaki and moser) they dont say anything about SWs..

  - sasaki2014: low SWR incidence sim to 0.1 ev/s


    %%%%%%%%%%%%%%%%%%%%%%%%%%%%% refs
    Kulik2006:
      -Gb1 and GIRK colocolize on the dendritic spines on PCs: on the shafts they are segregated, GIRK are not GABA driven
      -mostly in str. oriens, radiatum and lacunosum moleculare. are they active? i should have seen that in our recordings...

    Lacaille1991:
      - slow, possibly gB-meidated ipsps on INs (pyramidal layer)

    Lei2003:
      - presynaptic gB modulation of AMPA and GABAa receptors...
      - i50 value of baclofen is lower for i than for e synapses, suggesting i more senitive?
      - CGP55845 gB antagonist enhanced only IPSP but not epsps
      - activation of gB synapses normalized STD (+more refs on that; Davies1990 in in-in)

    Booker2013:
      - imunnolabeling: postsynaptic GIRk coupled on PV+ INs
      - gB also at the axons on PVINs
      - whole cell stimulation show large gB-mediated IPSPs on the perisomatic-targeting PVIN, but not on the DTI

    Hollnagel2014
      - gB antagonist didnt affect SWs
      - gB agonist decreased and stoped spontan SWs, but SWs could be evoked
      - baclofen effect was presynaptic

    degro2013:
      - postsynaptic gB over the whole somtodendritic axis of PCs
      - mostly in radiatum and LM 
