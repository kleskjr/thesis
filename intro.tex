...
\label{sec:hebb}
  ...
  paraphrase from ``neurons wire together if they fire together'' \citep{Lowel1992}}}}
    ...
    The first demonstration of the plastic nature of synapses was reported
...
\label{sec:swr}
  ...
  \subsection{Behavioural correlates}
    ...
    %In that last study, the EC replay
    %followed synchronous CA1 population events suggesting that the replay can,
    %nevertheless, be triggered by the hippocampus. ?here not very clear,???
